...
function createPostHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const body = req.body;
            const createdPost = yield posts_service_1.postsService.createPost(body);
            res.status(http_responses_1.http_response.created).send((0, map_to_post_util_1.mapToPost)(createdPost));
        }
        catch (err) {
