...
exports.blogsRepository = {
    createBlog(createBlogInput) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const insertedBlogId = yield mongo_db_1.blogCollection.insertOne(newBlog);
            return insertedBlogId.insertedId.toString();
        });
    },
    updateBlogById(id, updateBlogInput) {
        return __awaiter(this, void 0, void 0, function* () {
            const updatedBlog = yield mongo_db_1.blogCollection.updateOne({ _id: new mongodb_1.ObjectId(id) }, {
                $set: {
